...
plot_grid <- grid.arrange(plot_map, 
                          ...
                          layout_matrix = rbind(c(2, 1, 3),
                                                ...
                                                c(8, 8, 8)))
plot(plot_grid)
#ggsave(plot_grid, file="./Figures/grid_mixBE.png", width=9.5, height=5.5, scale=1/1.15)
#ggsave(plot_grid, file="./Figures/grid_mixBE.pdf", width=9.5, height=5.5, scale=1/1.15)
...
plot_grid <- grid.arrange(plot_map, 
                          ...
                          layout_matrix = rbind(c(2, 1, 3),
                                                ...
                                                c(8, 8, 8)))
plot(plot_grid)
#ggsave(plot_grid, file="./Figures/grid_outofBE.png", width=9.5, height=5.5, scale=1/1.15)
#ggsave(plot_grid, file="./Figures/grid_outofBE.pdf",width=9.5, height=5.5, scale=1/1.15)
...
plot_grid <- grid.arrange(plot_map, 
                          ...
                          layout_matrix = rbind(c(2, 1, 3),
                                                ...
                                                c(8, 8, 8)))
plot(plot_grid)
#ggsave(plot_grid, file="./Figures/grid_outofBE2.png", width=9.5, height=5.5, scale=1/1.15)
#ggsave(plot_grid, file="./Figures/grid_outofBE2.pdf", width=9.5, height=5.5, scale=1/1.15)
...
plot_grid <- grid.arrange(plot_map, 
                          ...
                          layout_matrix = rbind(c(2, 1, 3),
                                                ...
                                                c(8, 8, 8)))
plot(plot_grid)
#ggsave(plot_grid, file="./Figures/grid_outofBE3.png", width=9.5, height=5.5, scale=1/1.15)
#ggsave(plot_grid, file="./Figures/grid_outofBE3.pdf", width=9.5, height=5.5, scale=1/1.15)
...
plot_grid <- grid.arrange(plot_map, 
                          ...
                          layout_matrix = rbind(c(2, 1, 3),
                                                ...
                                                c(8, 8, 8)))
plot(plot_grid)
#ggsave(plot_grid, file="./Figures/grid_outofBE4.png", width=9.5, height=5.5, scale=1/1.15)
#ggsave(plot_grid, file="./Figures/grid_outofBE4.pdf", width=9.5, height=5.5, scale=1/1.15)
...
plot_grid <- grid.arrange(plot_map, 
                          ...
                          layout_matrix = rbind(c(2, 1, 3),
                                                ...
                                                c(8, 8, 8)))
plot(plot_grid)
#ggsave(plot_grid, file="./Figures/grid_outofBE5.png", width=9.5, height=5.5, scale=1/1.15)
#ggsave(plot_grid, file="./Figures/grid_outofBE5.pdf", width=9.5, height=5.5, scale=1/1.15)
```
...
library(ggpubr)
plot_grid <- ggarrange(plotmap1+coord_fixed(), plot1, plot2,
                       ncol = 1, nrow = 3,align = "v", 
                       heights = c(2.5, 2.5, 4))
plot(plot_grid)
#ggsave(plot_grid, file="./Figures/slice_switzerland1.png", width=8.5, height=7.5, scale=1.1)
#ggsave(plot_grid, file="./Figures/slice_switzerland1.pdf", width=8.5, height=7.5, scale=1.1)
...
final_plot <- plot_grid(p_mean+theme(plot.margin = unit(c(0, 0, 0, 0), "lines")), 
                        p_sd+theme(plot.margin = unit(c(0, 0, 0, 0), "lines")), 
                        p_median+theme(plot.margin = unit(c(0, 0, 0, 0), "lines")),
                        p_iq+theme(plot.margin = unit(c(0, 0, 0, 0), "lines")),
                        ncol = 2, nrow = 2,
...
plot(final_plot)
#ggsave(final_plot, file="./Figures/meanSwiss.png",width=8, height=6, scale=1)

#ggsave(final_plot, file="./Figures/meanSwiss.pdf",width=8, height=6, scale=1)
```
