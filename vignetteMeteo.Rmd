...
```{r plotMeanSwiss, fig.cap = "Summary of the SLGP probabilistic predictions for the expected temperatures in Switzerland.", fig.fullwidth=TRUE, fig.height=6.0, fig.width=8, fig.align='center',fig.pos="H", warning=FALSE, message=FALSE, echo=FALSE, include=FALSE}
...
final_plot <- ggarrange(
  p_mean, p_sd, p_median, p_iq,
  ncol = 2, nrow = 2,
  labels = NULL,  # Optional: Add labels like "A", "B", etc.
...
We now represent the corresponding maps.
```{r plotMeanSwiss, fig.cap = "Summary of the SLGP probabilistic predictions for the 10% quantile of temperatures in Switzerland.", fig.fullwidth=TRUE, fig.height=6.0, fig.width=8, fig.align='center',fig.pos="H", warning=FALSE, message=FALSE, echo=FALSE, include=FALSE}
