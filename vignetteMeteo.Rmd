...
plotDensities
ggsave(plotDensities+guides(col = "none") , file="./Figures/empiricalMeteo.png",
       width=8.5, height=7, scale=1.1)
ggsave(plotDensities+guides(col = "none") , file="./Figures/empiricalMeteo.pdf",
       width=8.5, height=7, scale=1.1)
...
```{r plotSlicesDrawn, fig.cap = "A slice across Switzerland", fig.fullwidth=TRUE, fig.height=6.0, fig.width=8, fig.align='center',fig.pos="H", warning=FALSE, message=FALSE, echo=FALSE}
disc_long <- 101
disc_lat <- 101
...
```{r plotSlice1Full, fig.cap = "A slice across Switzerland: Location on a map, Altitude Profile, Simultaneous quantile prediction and associated uncertainty", fig.fullwidth=TRUE, fig.height=5, fig.width=6, fig.align='center',fig.pos="H", warning=FALSE, message=FALSE, echo=FALSE}
plot2 <- 
  df_plot_meteo_summary_1 %>%
  dplyr::select(-mean)%>%
  pivot_longer(starts_with("q"))%>%
...
Of course, we can also simply visualise directly some quantities of interest (such as mean expected temperature, mean quantile) and the associated point-wise uncertainty (standard deviation, inter-quartile range) over the map of Switzerland.
...
```{r plotMeanSwiss, fig.cap = "Summary of the SLGP probabilistic predictions for the expected temperatures in Switzerland.", fig.fullwidth=TRUE, fig.height=6.0, fig.width=7, fig.align='center',fig.pos="H", warning=FALSE, message=FALSE, echo=FALSE}
...
plot(final_plot)
ggsave(final_plot, file="./Figures/meanSwiss.png",
       width=8, height=6, scale=1)

ggsave(final_plot, file="./Figures/meanSwiss.pdf",
       width=8, height=6, scale=1)
```

```{r plotq10Swiss, fig.cap = "Summary of the SLGP probabilistic predictions for the 10% quantile of temperatures in Switzerland.", fig.fullwidth=TRUE, fig.height=6.0, fig.width=7, fig.align='center',fig.pos="H", warning=FALSE, message=FALSE, echo=FALSE}
...
plot(final_plot)
ggsave(final_plot, file="./Figures/q10Swiss.png",
       width=8, height=6, scale=1)

ggsave(final_plot, file="./Figures/q10Swiss.pdf",
       width=8, height=6, scale=1)
```

```{r plotq50Swiss, fig.cap = "Summary of the SLGP probabilistic predictions for the 50% quantile of temperatures in Switzerland.", fig.fullwidth=TRUE, fig.height=6.0, fig.width=7, fig.align='center',fig.pos="H", warning=FALSE, message=FALSE, echo=FALSE}
...
plot(final_plot)
ggsave(final_plot, file="./Figures/q50Swiss.png",
       width=8, height=6, scale=1)

ggsave(final_plot, file="./Figures/q50Swiss.pdf",
       width=8, height=6, scale=1)
```

```{r plotq90Swiss, fig.cap = "Summary of the SLGP probabilistic predictions for the 90% quantile of temperatures in Switzerland.", fig.fullwidth=TRUE, fig.height=6.0, fig.width=7, fig.align='center',fig.pos="H", warning=FALSE, message=FALSE, echo=FALSE}
...
plot(final_plot)
ggsave(final_plot, file="./Figures/q90Swiss.png",
       width=8, height=6, scale=1)

ggsave(final_plot, file="./Figures/q90Swiss.pdf",
       width=8, height=6, scale=1)
```
